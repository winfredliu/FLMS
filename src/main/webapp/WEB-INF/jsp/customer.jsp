	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">华迪融资租赁管理系统</a>
			</div>

			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="${pageContext.request.contextPath}/toCustomer.action">主页 <span class="sr-only">(current)</span></a></li>
	...
	<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-6 col-md-3">
					<div class="thumbnail" style="border: none">
						<div class="caption">
							<span class="glyphicon glyphicon-usd" style="font-size: xx-large" aria-hidden="true"></span>
							<h3>员工工资结算</h3>
							<p>对员工的工资进行结算，存入数据库处理...</p>
							<p><a href="${pageContext.request.contextPath }/JobsWorkerslist2.action" class="btn btn-primary" role="button">进入</a></p>
						</div>
					</div>
				</div>
			</div>
